...
/**
 * class:   STTestFileSystem
 * package: com.globalros.tftp.test
 * project: tftp4java
 * 
 * This class is a modified version off the FileSystem class that SingleThreaded-Threaded
 * test units for TFTP uses.
 * 
 * The reason for this file is so that the ST unit tests are able to work against
 ...
 *  
 */
public class STTestFileSystem implements VirtualFileSystem
{
   /**
    * logger
    */
   ...
   {            
      Map myMap = TFTPClientTest.getMap();                
